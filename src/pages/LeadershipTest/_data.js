...
const questions = [
  ...
  {
    id: 3,
    background: "도(道) 농업기술원에서 파견된 기술자가 마을 회관에서 새로운 영농 기술을 소개했습니다. 기존보다 3배 높은 수확량을 낼 수 있다고 하지만, 도입에 필요한 초기 비용과 낯선 방식에 대한 두려움이 있습니다. 마을 어른들은 '검증도 안 된 것을 왜 하냐'며 반신반의하고 있고, 젊은층은 '해보자'는 눈빛입니다.",
