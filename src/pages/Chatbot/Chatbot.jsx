...
const RELEASE_NOTES = [
  ...
  },
  {
    ...
    date: "2026-07-09",
    patches: [
      "eBook 리더 독립 스크롤 최적화: **[듀얼 패널 높이 고정 독립 스크롤]** 뷰포트 레이아웃 탑재 (원본 PDF 위치 고정 대조 기능 극대화)",
      "eBook 조작 패널 정리: 다국어 설정, 검색, 제안, 대시보드 버튼들을 감추는 **[헤더 햄버거 드롭다운 메뉴]** 통합",
      "eBook 이동 동선 개선: 오류 대시보드 및 햄버거 메뉴 내 **[목차로 돌아가기]** 에메랄드 핫링크 버튼 구현",
      "보안 위협 제거: Groq API 키 및 Firebase 환경변수화로 소스코드 노출 방지, 피드백 비밀번호 **SHA-256 해시 단방향 암호화** 적용",
      "성능 최적화: eBook 포인트 가산 쿼리 **getDoc 단건 참조** 변경 (Users 컬렉션 전체 로드 비용 100% 절감)"
    ]
  },
  {
    version: "v1.3.6",
...
[영광의 발자취 (마을단위 새마을운동 추진사) 핵심 사례 및 딥링크 페이지 정보]
- 돗재도로 개설 (전남 화순군 한천면): 주민 12,000명의 자발적 부역 노동으로 험난한 돗재 고개 4.3km 도로를 개설하여 유통 및 소득 증대. (이북 주소: /reader/glory?page=33)
- 구담교 가설 (경북 안동군 풍천면): 낙동강 지류를 연결하는 158m 교량을 주민 협동으로 가설하여 30년간의 뗏목 우회 문제와 통학 애로 해결. (이북 주소: /reader/glory?page=46)
- 탁박골마을 자립 (경기 부천시 소사동): 전기가 없고 도로가 없는 삼무(三無) 달동네를 주민 주도의 공동 노력으로 자립형 주거지로 극복. (이북 주소: /reader/glory?page=73)
- 율동마을 복지촌 (경기 안성군 일죽면): 예비역 상사 지도자의 솔선수범으로 도박 소굴을 타파하고, 농토 1000평 및 공동목욕탕 등 방대한 공동자산을 보유한 부촌 구축. (이북 주소: /reader/glory?page=141)
- 도원1리 산림녹화 (강원 영월군 수주면): 소나무와 잣나무 등 26만여 본을 주민 협동으로 조림하여 울창한 사방공사 및 임업 소득원 확보 성공. (이북 주소: /reader/glory?page=170)
- 남평리 고랭지 채소 (강원 정선군 북면): 고랭지 채소 작목반 결성 및 오이/고추 공동 출하로 영세 산골 농가의 실질 소득을 대폭 증대시킴. (이북 주소: /reader/glory?page=191)
- 도사리마을 경지정리 (강원 양구군 양구면): 개간 불가능하던 수렁논 15.5ha를 경지 정리하여 기계화 영농을 실현하고 쌀 생산량 대폭 증대. (이북 주소: /reader/glory?page=205)
- 금산2리 주택개선 (강원 명주군 성산면): 167호의 전통 지붕을 현대식으로 개량하고 공동구판장을 설립하여 위생 및 복지 표준 수립. (이북 주소: /reader/glory?page=224)
- 잣미마을 의식개혁 (충북 보은군 내북면): 미신 숭배와 나태함, 지독한 장리빚에 시달리던 오지를 새마을금고 중심의 저축과 의식개혁으로 타파. (이북 주소: /reader/glory?page=287)
- 상례곡리 농로 확장 (충북 옥천군 청산면): 차량 진입이 가능하게 농로 10km를 확장하여 현대식 경운기 영농 및 소형 기계화 전면 도입. (이북 주소: /reader/glory?page=306)
- 복대2리 부업 소득 (충남 서천군 판교면): 농한기 부녀회 주도의 공동 가마니 짜기 및 공예 공동 판매로 농가 부업 소득 획기적 제고. (이북 주소: /reader/glory?page=403)

[새마을운동 10년사 내용 정보]
- 새마을운동의 3대 정신(근면, 자조, 협동) 및 역사적 추진 과정, 국가 정책 흐름이 상세하게 수록된 종합 기록 도서입니다. (이북 주소: /reader/10years?page=페이지번호)
